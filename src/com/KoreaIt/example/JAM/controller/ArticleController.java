...
public class ArticleController {
	...
	public void showList(String cmd) {
		// article list 뒤에 아무것도 없다면 리스트가 쭉 나오고
		// article list 뒤에 검색어가 붙는다면 관련 리스트가 쭉 나오게
		...
		System.out.println("번호	|	제목	|	작성자	|	조회수	|	작성일자");

		for (Article article : articles) {
			System.out.printf("%d	|	%s	|	%s	|	%d	|	%s\n", article.id, article.title, article.name, article.viewCount, Util.datetimeFormat(article.updateDate));
		}
	}
